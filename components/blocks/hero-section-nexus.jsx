   ...
   <AnimatePresence>
     {isOpen && (
       <motion.div
           ...
           <div
               className="bg-[#111111] border border-gray-700/50 rounded-md shadow-xl p-2">
               {children}
           </div>
       </motion.div>
     )}
...
const InteractiveHero = () => {
  ...
  return (
      <div
          className="pt-[100px] relative bg-[#111111] text-gray-300 min-h-screen flex flex-col overflow-x-hidden">
          <canvas
              ref={canvasRef}
          ...
          <main
              className="flex-grow flex flex-col items-center justify-center text-center px-4 pt-8 pb-16 relative z-10">
...
ChitChat<br />{' '}
                  <span
                      ...
                      <RotatingText
                          texts={['Relationships', 'Friends', 'Video Chat Available', 'Voice Chat Available','Faster']}
...
type='button'
                      className="w-full  flex gap-x-2 items-center sm:w-auto bg-[#0CF2A0] text-[#111111] px-5 py-2 rounded-md text-sm font-semibold hover:bg-opacity-90 transition-colors duration-200 whitespace-nowrap shadow-sm hover:shadow-md flex-shrink-0"
                      whileHover={{ scale: 1.03, y: -1 }}
                      whileTap={{ scale: 0.97 }}
                      transition={{ type: "spring", stiffness: 400, damping: 15 }}>
                      Start Chat <CursorArrowIcon/>
                  </motion.button>
              </motion.form>
              ...
              <motion.div
                  ...
                  initial="hidden"
                  animate="visible"
                  className="w-full mt-10 max-w-4xl mx-auto px-4 sm:px-0">
                  <img
